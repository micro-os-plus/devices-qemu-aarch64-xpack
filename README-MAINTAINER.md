...
Determine the upstream version (like `5.0.0`) and eventually update the
...
- add a new entry like _\* v5.0.0_
...
- `npm dist-tag add @micro-os-plus/devices-qemu-aarch64@5.0.0 latest`
- `npm dist-tag ls @micro-os-plus/devices-qemu-aarch64`
