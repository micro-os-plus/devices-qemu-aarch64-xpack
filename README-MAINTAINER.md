...
Determine the upstream version (like `4.1.1`) and eventually update the
`package.json` file; the format is `4.1.1-pre`.
...
- `npm dist-tag add @micro-os-plus/devices-qemu-aarch64@4.1.1 latest`
- `npm dist-tag ls @micro-os-plus/devices-qemu-aarch64`
