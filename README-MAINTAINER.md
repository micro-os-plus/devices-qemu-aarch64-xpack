...
Determine the upstream version (like `5.0.1`) and eventually update the
`package.json` file; the format is `5.0.1-pre`.
...
and fix them; assign them to a milestone (like `5.0.1`).
...
- add a new entry like _\* v5.0.1_
- commit with a message like _prepare v5.0.1_
...
- `npm dist-tag add @micro-os-plus/devices-qemu-aarch64@5.0.1 latest`
- `npm dist-tag ls @micro-os-plus/devices-qemu-aarch64`
